        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {sucursales.map((suc, idx) => (
              <div key={idx} className="bg-[#0a0a0c] border border-zinc-900/80 rounded-xl p-4 flex flex-col justify-between hover:border-zinc-800 transition-colors">
                <div>
                ...
                <div className="text-right mt-2 text-xs font-bold text-primary font-mono">{suc.tel}</div>
              </div>
            ))}
          </div>
        </div>

        {/* Columna 3: Cuentas y Admin */}
